...
def search_android_projects(csv_file):
    #cursor = collection.find({'description': {'$regex': 'android', '$options': 'i'},
    #                          'stargazers_count': {'$gt': 50}, 'updated_at': {'$gte': start_date}})
...
def filter_by_archive(project):
    ...
    #is_archived = json.loads(json_data)["archived"]
