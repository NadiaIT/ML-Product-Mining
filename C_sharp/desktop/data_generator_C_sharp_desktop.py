...
ML_library_keyword = ['weka.', 'tensorflow', 'Stanford.NLP', 'nd4j', 'new MLContext()', 'Microsoft.ML', 'opencvdotnet',
                      'using Emgu.CV', 'AForge.MachineLearning', 'AForge.Neuro', 'Accord', 'AForge', 'Encog',
                      'GeneticSharp', 'InferNet', 'SynapsesCSharp', 'MxNet', 'MathNet.Numerics', 'numl.' 'Catalyst',
                      'RProvider', 'FSharp.Data', 'Spreads', 'NeuralNetworkNET', 'NumSharp', 'SciSharpCube']
ML_library_keyword_py = ['numpy', 'scipy', 'sklearn', 'theano', 'mlpack', 'seaborn', 'orange3', 'DiffSharp'
                         'torch', 'pandas', 'keras', 'matplotlib', 'plotly', 'nltk', 'opennn', 'dynet', 
                         'shogun', 'fann', 'armadillo', 'Vulpes', 'Deedle', 'FSharp', 'm2cgen']
code_extensions = ['.py', '.cs', 'fs', '.xaml.cs', '.ipynb', '.cpp', '.c', '.h', '.hpp', '.ss', '.json', '.kt', '.dart']
