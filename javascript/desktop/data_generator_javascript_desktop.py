...
collection = db.javascript_projects
apk_mentions = ['exe ', 'executable', 'windows', 'desktop', 'macOS', 'linux', 'installer', 
                'download and install', 'release']
apk_link = ['.exe', '.zip', '.dmg', '.pkg', '.jar', '.dll']
ML_library_keyword = ['new convnetjs.', 'new brain.', 'deeplearn', 'Mind()', 'neuro.classifiers',
                      'neuro.features', 'synaptic', '@tensorflow/tfjs', 'webdnn', '@stdlib/ml',
                      'require(\'brain\')', 'require("brain")', 'require("neuro.js")',
                      'require(\'neuro.js\')', 'architect.Perceptron', 'architect.LSTM',
                      'architect.NARX', 'neataptic.', 'require(\'ml-', 'require("ml-',
                      'from \'ml-', 'from "ml-', 'ml.min.js', 'ml.js', 'ml5.', 'ml5.min.js',
                      'keras-js', 'new KerasJS.', 'mathjs', 'math.js', 'require(\'limdu\')',
                      'require("limdu")', 'new limdu.', 'limdu.classifiers', 'limdu.features',
                      'import mxnet', 'from \'compromise', 'from "compromise', 'require(\'node-nlp\')',
                      'require("node-nlp")', 'new NlpManager', 'new natural.', 'require(\'natural\')',
                      'require("natural")', 'com.google.firebase.ml', 'com.google.mlkit']
ML_library_keyword_py = ['weka.', 'tensorflow', 'import numpy', 'from numpy', 'from scipy', 'import scipy',
                      ...
                      'from lightgbm', 'import catboost', 'import fastai', 'from gluonnlp',
                         'orange3', 'DiffSharp', 'opennn', 'dynet', 'fann', 'armadillo',
                         'Vulpes', 'Deedle', 'FSharp', 'm2cgen', 'opencv', 'bigml.com', 'bigml.io']
code_extensions = ['.js', '.ts', '.jsx', '.py', '.ipynb', '.json', '.xml', '.webgmex']
