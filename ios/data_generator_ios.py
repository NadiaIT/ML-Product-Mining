...
collection = db.ios_projects
apk_mentions = ['app store', 'apple store', 'apple app']
apk_link = ['itunes.apple.com', 'apps.apple.com']
...
code_extensions = ['.swift', '.m', '.py', '.ipynb', '.cpp', '.c', '.h', '.hpp', '.ss', '.kt', '.dart']
