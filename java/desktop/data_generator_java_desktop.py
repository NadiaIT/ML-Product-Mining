...
collection = db.java_projects_corrected


apk_mentions = ['exe ', 'executable', 'windows', 'desktop', 'macOS', 'linux', 'installer', 'download and install']
apk_link = ['.exe', '.zip', '.dmg', '.pkg', '.jar']
